...
COMPILER_CXX = 'g++'
CPP = '/usr/bin/cpp'
CPPFLAGS_NODE = ['-D_GNU_SOURCE', '-arch', 'i386']
...
CXXFLAGS = ['-g', '-Wall', '-O3']
CXXFLAGS_DEBUG = ['-g']
CXXFLAGS_NODE = ['-D_LARGEFILE_SOURCE', '-D_FILE_OFFSET_BITS=64', '-arch', 'i386']
CXXFLAGS_RELEASE = ['-O2']
CXXLNK_SRC_F = ''
CXXLNK_TGT_F = ['-o', '']
CXX_NAME = 'gcc'
...
LIBDIR = '/Users/davidmosher/.node_libraries'
...
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/davidmosher/.node_libraries'
PREFIX = '/usr/local'
